      ...
      <div className="flex flex-wrap gap-5 items-center px-4 md:px-5 md:py-5 justify-center border border-border py-4 rounded-lg">
        <div className="grid !gap-0">
          <div className='flex items-center justify-center'>
            <CountUp start={00.1} end={247} className='text-2xl md:text-2.5xl' />
        ...
        <div className="grid !gap-0">
        <div className='flex items-center justify-center'>
            <CountUp start={00.01} end={1849} className='text-2xl md:text-2.5xl' />
            <span className='text-2xl md:text-2.5xl'>+</span>
          </div>
        ...
        <div className="grid !gap-0">
        <div className='flex items-center justify-center'>
            <CountUp start={00.001} end={85679} className='text-2xl md:text-2.5xl' />
            <span className='text-2xl md:text-2.5xl'>+</span>
          </div>
