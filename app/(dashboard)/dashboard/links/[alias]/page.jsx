    ...
    <main className="px-6 md:px-20 lg:px-44 py-10 grid gap-7">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {typeof window !== "undefined" &&
              `https://${window.location.host}/${alias}`}
          </p>
        </div>
      </div>
      ...
      <div className="border rounded-lg grid grid-cols-2 md:grid-cols-4 bg-card shadow-sm">
        <div className="text-center p-4 border-r border-border">
          <h2 className="text-2xl">
            <CountUp end={linkData.totalClicks} start={0} />
          </h2>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Clicks by hour of day (last 30 days)
          </CardDescription>
        </CardHeader>
        <CardContent>
          {hourlyBreakdown.length > 0 ? (
            <ChartContainer config={{ clicks: { label: "Clicks" } }}>
              <BarChart barSize={20} data={hourlyBreakdown}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis
                  dataKey="hour"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Detailed list of individual clicks ({clickLog.total} total)
          </CardDescription>
        </CardHeader>
        <CardContent>
          {clickLogLoading ? (
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setClickLogPage((p) =>
                          Math.min(clickLog.totalPages, p + 1),
                        )
                      }
                      disabled={
                        clickLogPage === clickLog.totalPages || clickLogLoading
                      }
                    >
                      Next
                    </Button>
          ...
          {clickLog.clicks.length > 0 ? (
            <div className="space-y-4">
              {clickLog.clicks.map((click, index) => {
                ...
                const prevClickDate =
                  index > 0
                    ? new Date(clickLog.clicks[index - 1].timestamp)
                    : null;
                const isNewDay =
                  !prevClickDate ||
